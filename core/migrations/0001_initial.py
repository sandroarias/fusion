    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('ini-cog', 'Engrengem'), ('ini-stats-up', 'Gráfico'), ('ini-users', 'Usuários'), ('ini-layers', 'Design'), ('ini-mobile', 'Mobile'), ('ini-rocket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
